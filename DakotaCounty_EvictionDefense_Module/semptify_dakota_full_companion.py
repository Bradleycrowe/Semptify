...
# -*- coding: utf-8 -*-
"""
Semptify - Dakota County Eviction Defense (FastAPI, interactive modal + ALL add-ons + Court Companion)

Run:
  pip install fastapi uvicorn
  python semptify_dakota_full_companion.py
...
def scaffold_files():
    ...
    # Templates: Answer, Counterclaim, Motions
...
**Request:** Pause enforcement pending disbursement of approved assistance.
...
Purpose: Push-button tools to generate Answer + Counterclaim, organize evidence, track deadlines, and click through state law, federal protections, funding, online court procedures, and trial scenarios. Includes Court Companion for live hearings.
...
app = FastAPI(title="Semptify - Dakota County Eviction Defense (All Add-Ons + Court Companion)", version="1.2")
