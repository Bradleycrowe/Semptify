...
Write-Host "
=== Creating Unified Semptify System ===" -ForegroundColor Cyan

# Create system_architecture.py
$system_code = @'
"""
...
class CaseAttributes:
    ...
    REQUIRED_DOCS = {
        ...
        "harassment": [DocumentType.COMMUNICATION, DocumentType.WITNESS_STATEMENT, DocumentType.INCIDENT],
    }
...
Set-Content -Path system_architecture.py -Value $system_code -Encoding utf8
Write-Host "✓ Created system_architecture.py" -ForegroundColor Green
